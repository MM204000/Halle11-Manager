...
def main():
    ...
    # Absicherung: Altfarben auch in den erst von navigation.py eingesetzten Formen umfärben (Diagramm-XML ausgenommen)
    run([PY, os.path.join(HERE, "finish_sheets.py"), "recolor", stage])
